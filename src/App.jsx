...
const Badge = ({ children, color = "#00a550", bg, style = {} }) => (
  <span style={{
    ...
    fontFamily: "var(--font-d)", letterSpacing: 0.5, ...style
  }}>{children}</span>
);
...
const Card = ({ children, style = {}, onClick }) => (
  <div onClick={onClick} style={{
    ...
    borderRadius: 12, padding: 16, ...style, cursor: onClick ? "pointer" : "default"
  }}>{children}</div>
);
...
const LiveDot = () => (
  <span style={{
    display: "inline-block", width: 6, height: 6, background: "var(--red)",
...
const Header = ({ user, nav, betSlip }) => (
  <header style={{
    background: "var(--hbg)", borderBottom: "1px solid var(--border)",
    position: "sticky", top: 0, zIndex: 200, height: 56
  }}>
    <div style={{
      maxWidth: 430, margin: "0 auto", height: "100%", display: "flex",
          ...
          <button key={t.id} onClick={() => nav(t.id)} style={{
            ...
            {t.id === "sports" && betSlip.length > 0 && (
              <span style={{
                ...
                fontFamily: "var(--font-d)", fontWeight: 700, animation: "pop 0.3s ease"
              }}>{betSlip.length}</span>
            )}
...
const Ticker = () => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        background: "var(--red)", padding: "0 10px", height: "100%",
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <div style={{
          padding: "0 16px 8px", display: "flex", justifyContent: "space-between", alignItems: "center",
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 8 }}>
              {[100, 500, 1000, 5000].map(q => (
                <button key={q} onClick={() => setStake(String((parseFloat(stake) || 0) + q))}
                  style={{
                    flex: 1, padding: "6px", background: "var(--bg2)", border: "1px solid var(--border)",
                    borderRadius: 6, color: "var(--text2)", fontSize: 12, fontFamily: "var(--font-b)", cursor: "pointer"
                  }}>+{fmtN(q)}</button>
              ))}
            </div>
          </div>
          <div style={{
            background: "var(--bg2)", borderRadius: 10, padding: 12, marginBottom: 16,
            border: "1px solid var(--border)"
          }}>
            ...
            <div style={{ background: "var(--bg2)", borderRadius: 10, padding: 16, border: "1px solid var(--accent)" }}>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                ...
                <Btn fullWidth onClick={() => {
                  ...
                  setBetHistory(h => [{
                    id: "BET" + Date.now(), selections: betSlip.map(s => ({ match: s.match, pick: s.pick, odds: s.odds })),
                    stake: amt, returns: parseFloat(potential), status: "pending", date: "Just now"
                  }, ...h]);
    ...
    <div style={{ minHeight: "100vh", background: "var(--bg)", display: "flex", flexDirection: "column", alignItems: "center", padding: "0 0 80px" }}>
      <div style={{ width: "100%", maxWidth: 430, padding: "40px 24px 0" }}>
        ...
        <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 200, overflow: "hidden", zIndex: 0, pointerEvents: "none" }}>
          {[...Array(8)].map((_, i) => (
            <div key={i} style={{
              position: "absolute", top: 0, left: `${i * 14 - 10}%`, width: "12%", height: "100%",
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <div style={{ marginBottom: 12 }}>
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  <input value={otp} onChange={e => setOtp(e.target.value)} placeholder="6-digit code"
                    style={{
                      flex: 1, background: "var(--bg3)", border: "1px solid var(--accent)", borderRadius: 8,
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16, marginTop: 8 }}>
              <div onClick={() => setAgreed(!agreed)} style={{
                width: 18, height: 18, background: agreed ? "var(--accent)" : "var(--bg3)",
    ...
    <div style={{ paddingBottom: 80 }}>
      ...
      <div style={{ padding: "12px 14px 0" }}>
        <div style={{ position: "relative", overflow: "hidden", borderRadius: 14 }}>
          {BANNERS.map((b, i) => (
            <div key={i} style={{
              display: banner === i ? "block" : "none",
              background: `linear-gradient(${b.gradient})`,
              borderRadius: 14, padding: 20, position: "relative", overflow: "hidden"
            }}>
              {[...Array(6)].map((_, j) => (
                <div key={j} style={{
                  position: "absolute", bottom: -20, left: `${j * 20 - 10}%`,
      ...
      {/* Sport tabs */}
      <div style={{
        padding: "14px 0 0", overflowX: "auto", display: "flex", gap: 0, paddingLeft: 14,
          ...
          <div style={{ display: "flex", gap: 10, overflowX: "auto", paddingBottom: 8, scrollbarWidth: "none" }}>
            {livematches.map(m => (
              <div key={m.id} style={{
                ...
                <div style={{
                  fontFamily: "var(--font-d)", fontSize: 22, fontWeight: 700, textAlign: "center",
                  margin: "4px 0", color: "var(--accent)"
                }}>{m.homeScore} - {m.awayScore}</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 8 }}>
          {QUICK_GAMES.map(g => (
            <div key={g.name} onClick={() => { if (g.view === "crash") nav("crash"); else nav("casino"); }}
              style={{
                background: `linear-gradient(135deg,${g.gradient})`, borderRadius: 12,
              ...
              {g.hot && <div style={{
                position: "absolute", top: 8, right: 8, fontSize: 11, background: "rgba(0,0,0,0.4)",
        ...
        {activeTab === "matches" ? (
          leagues.length === 0 ? (
            ...
            return (
              <div key={league}>
                <div style={{
                  background: "var(--bg2)", padding: "8px 14px", display: "flex",
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 6, minWidth: 130 }}>
                        {[
                          ...
                          <button key={i} onClick={() => addToBetSlip(m, o.pick, o.odds)}
                            ...
                            <span style={{
                              fontFamily: "var(--font-d)", fontSize: 17, fontWeight: 700,
                              color: isSelected(m, o.pick) ? "#fff" : "var(--text)"
                            }}>{isSelected(m, o.pick) ? "✓ " : ""}{fmtOdds(o.odds)}</span>
                          </button>
                        ))}
                      </div>
                    </div>
          ...
          <div style={{ padding: 14 }}>
            {betHistory.length === 0 ? (
              ...
              <div key={i} style={{
                background: "var(--card)", border: `1px solid ${b.status === "won" ? "var(--accent)" : b.status === "lost" ? "var(--red)" : "var(--border)"}`,
                ...
                <div style={{
                  ...
                  <span style={{
                    fontSize: 13, fontFamily: "var(--font-d)", fontWeight: 700,
  ...
  useEffect(() => {
    ...
    const chatInt = setInterval(() => {
      ...
      setChat(c => [{
        ...
        msg: NEW_CHAT_MSGS[Math.floor(Math.random() * NEW_CHAT_MSGS.length)], time: "Just now"
      }, ...c.slice(0, 19)]);
    }, 4000);
    ...
    <div style={{ flex: 1, background: "var(--card)", borderRadius: 12, padding: 14, border: `1px solid ${bet.placed ? "var(--accent)" : "var(--border)"}` }}>
      ...
      <div style={{ display: "flex", gap: 4, marginBottom: 10 }}>
        {[100, 500, 1000, 2000].map(q => (
          <button key={q} disabled={bet.placed} onClick={() => setBet(b => ({ ...b, stake: String(q) }))}
            style={{
              flex: 1, padding: "4px 2px", background: "var(--bg2)", border: "1px solid var(--border)",
              borderRadius: 6, color: "var(--text2)", fontSize: 10, cursor: "pointer", opacity: bet.placed ? 0.4 : 1
            }}>{fmtN(q)}</button>
        ))}
      </div>
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
        <div onClick={() => setBet(b => ({ ...b, autoOn: !b.autoOn }))} style={{
          ...
          <div style={{
            position: "absolute", top: 2, left: bet.autoOn ? 14 : 2, width: 14, height: 14,
        ...
        {bet.autoOn && <input type="number" placeholder="2.00" value={bet.autoAt}
          ...
          style={{
            width: 60, background: "var(--bg2)", border: "1px solid var(--accent)", borderRadius: 6,
      ...
      {state === "running" && bet.placed && !bet.cashedOut && (
        <button onClick={() => cashOut(bet, setBet)} style={{
  ...
  return (
    <div style={{ paddingBottom: 80 }}>
      ...
      <div style={{ padding: "10px 14px 6px", overflowX: "auto", display: "flex", gap: 6, scrollbarWidth: "none" }}>
        {history.map((v, i) => (
          <div key={i} style={{
            background: chipColor(v) + "22", border: `1px solid ${chipColor(v)}`,
            borderRadius: 6, padding: "3px 8px", flexShrink: 0,
            fontFamily: "var(--font-d)", fontSize: 13, fontWeight: 700, color: chipColor(v)
          }}>{v.toFixed(2)}x</div>
        ))}
      </div>
      {/* Canvas */}
      <div style={{
        margin: "0 14px", background: "var(--bg2)", borderRadius: 14, border: "1px solid var(--border)",
        overflow: "hidden", position: "relative",
        animation: state === "crashed" ? "crash-shake 0.5s ease" : "none"
      }}>
        {state === "crashed" && <div style={{
          position: "absolute", inset: 0, background: "rgba(232,17,45,0.2)",
        ...
        <div style={{
          ...
          {state === "running" && (
            <div>
              <div style={{
                fontFamily: "var(--font-d)", fontSize: 72, fontWeight: 700, lineHeight: 1,
                animation: "mult-glow 1s ease infinite", color: "#fff"
              }}>{fmtOdds(multiplier)}x</div>
      ...
      <div style={{ padding: "0 14px" }}>
            ...
            {players.map((p, i) => (
              <div key={i} style={{
                ...
                <div style={{ flex: 1, display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <span style={{
                    fontSize: 12, color: p.status === "bust" ? "var(--text2)" : "var(--text)",
                    textDecoration: p.status === "bust" ? "line-through" : "none"
                  }}>{p.name}</span>
                </div>
                ...
                <span style={{
                  width: 70, textAlign: "right", fontSize: 12, fontFamily: "var(--font-d)", fontWeight: 700,
        ...
        {pTab === "history" && (
          <div style={{ background: "var(--card)", borderRadius: 12, border: "1px solid var(--border)", overflow: "hidden" }}>
            ...
            {myHistory.map((r, i) => (
              <div key={i} style={{
                display: "flex", padding: "8px 12px", borderTop: "1px solid var(--border)",
                background: r.profit > 0 ? "rgba(0,165,80,0.05)" : "rgba(232,17,45,0.05)"
              }}>
                <span style={{
                  flex: 1, fontFamily: "var(--font-d)", fontWeight: 700,
                  color: chipColor(r.crash)
                }}>{r.crash.toFixed(2)}x</span>
...
const CasinoPage = ({ nav, addToast }) => {
  ...
  const filtered = CASINO_GAMES.filter(g => {
    if (cat !== "all" && !g.name.toLowerCase().includes(cat.toLowerCase()) && !g.provider.toLowerCase().includes(cat.toLowerCase())) return false;
  ...
  return (
    <div style={{ paddingBottom: 80 }}>
      ...
      {/* Featured */}
      <div style={{
        margin: "0 14px 16px", background: "linear-gradient(135deg,#00a550,#003d1f)",
        borderRadius: 14, padding: 20, position: "relative", overflow: "hidden"
      }}>
        {[...Array(5)].map((_, i) => <div key={i} style={{
          position: "absolute", top: -20, left: `${i * 25}%`,
          ...
          <div key={g.name} onClick={() => g.iscrash ? nav("crash") : setModal(g)}
            ...
            <div style={{
              ...
              {g.badge && <div style={{
                ...
                borderRadius: 4, padding: "2px 6px", fontSize: 10, color: "#fff", fontWeight: 600
              }}>{g.badge}</div>}
      ...
      {modal && (
        <>
          ...
          <div style={{
            ...
            <div style={{
              background: `linear-gradient(135deg,${modal.gradient})`, borderRadius: 12,
            ...
            <div style={{
              background: "var(--gold)22", border: "1px solid var(--gold)", borderRadius: 10,
...
const WalletPage = ({ user, setUser, transactions, setTransactions, addToast }) => {
  ...
  const confirmDeposit = () => {
    ...
    setUser(u => ({ ...u, balance: u.balance + amt }));
    setTransactions(t => [{
      id: "TXN" + Date.now(), type: "deposit", method: methods.find(m => m.id === method)?.label,
      amount: amt, status: "Completed", date: "Just now"
    }, ...t]);
  ...
  const confirmWithdraw = () => {
    ...
    setUser(u => ({ ...u, balance: u.balance - amt }));
    setTransactions(t => [{
      id: "TXN" + Date.now(), type: "withdraw", method: methods.find(m => m.id === method)?.label,
      amount: amt, status: "Pending", date: "Just now"
    }, ...t]);
  ...
  return (
    <div style={{ paddingBottom: 80 }}>
      {/* Balance card */}
      <div style={{
        margin: 14, background: "linear-gradient(135deg,var(--accent-d),#002d1a)", borderRadius: 16,
        ...
        {(tab === "deposit" || tab === "withdraw") && <>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 8, marginBottom: 16 }}>
            ...
            <button onClick={() => setAmount("")} style={{
              ...
              border: "1px solid var(--border)", borderRadius: 8, color: "var(--text2)", cursor: "pointer", fontSize: 13
            }}>Custom</button>
          </div>
...
const PromosPage = ({ user, addToast }) => {
  ...
  return (
    <div style={{ paddingBottom: 80, padding: "14px 14px 80px" }}>
      ...
      {/* Welcome Bonus */}
      <div style={{
        background: "linear-gradient(135deg,#00a550 0%,#e8112d 100%)", borderRadius: 16,
      ...
      <Card style={{ marginBottom: 12 }}>
        ...
        <div style={{ display: "flex", gap: 6, marginBottom: 14 }}>
          {streak.map((done, i) => (
            <div key={i} style={{
              flex: 1, height: 40, borderRadius: 8, display: "flex", flexDirection: "column",
      ...
      <Card style={{ marginBottom: 12 }}>
        ...
        <div style={{ background: "var(--bg2)", borderRadius: 10, padding: 12, marginBottom: 10, border: "1px solid var(--border)" }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <div style={{
              flex: 1, fontFamily: "var(--font-d)", fontSize: 22, fontWeight: 700, color: "var(--accent)",
              background: "var(--bg3)", borderRadius: 8, padding: "8px 12px", letterSpacing: 2
          ...
          {[{ n: "Rahim***", d: "Jan 3", e: 200, done: true }, { n: "Shah***", d: "Jan 1", e: 200, done: true }, { n: "Jami***", d: "Dec 28", e: 200, done: true }, { n: "Nabi***", d: "Dec 20", e: 0, done: false }].map((r, i) => (
            <div key={i} style={{
              ...
              <div style={{
                ...
                color: r.done ? "var(--accent)" : "var(--text2)"
              }}>{r.n[0]}</div>
              <div style={{ flex: 1 }}>
      ...
      <Card style={{ marginBottom: 12 }}>
        ...
        <div style={{ display: "flex", gap: 6 }}>
          {[{ n: 3, b: "+5%" }, { n: 5, b: "+10%" }, { n: 7, b: "+20%" }].map(r => (
            <div key={r.n} style={{
              flex: 1, background: "var(--bg2)", borderRadius: 10, padding: "10px 6px",
...
const VIPPage = ({ user }) => {
  ...
  return (
    <div style={{ paddingBottom: 80, padding: "14px 14px 80px" }}>
      {/* Hero card */}
      <div style={{
        background: `linear-gradient(135deg,${tierColor(user.tier)}33,${tierColor(user.tier)}11)`,
        ...
        <div style={{
          fontFamily: "var(--font-d)", fontSize: 28, fontWeight: 700, color: tierColor(user.tier),
          letterSpacing: 2, marginBottom: 2
        }}>{user.tier.toUpperCase()} MEMBER</div>
      ...
      <Card style={{ marginBottom: 20 }}>
        ...
        <div style={{ height: 8, background: "var(--border)", borderRadius: 4, marginBottom: 8, overflow: "hidden" }}>
          <div style={{
            height: "100%", width: `${user.tierProgress}%`,
      ...
      {VIP_TIERS.map((tier, i) => (
        <div key={tier.name} style={{
          background: tier.name === user.tier ? tier.color + "11" : "var(--card)",
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", marginBottom: 8 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div style={{
                width: 36, height: 36, borderRadius: "50%", background: tier.color + "22",
...
const AccountPage = ({ user, setUser, nav, onLogout, addToast, setAdminAuthed }) => {
  ...
  return (
    <div style={{ paddingBottom: 80 }}>
      {/* Profile header */}
      <div style={{
        background: "linear-gradient(135deg,var(--accent-d),#001a0d)", padding: "24px 14px 20px",
        position: "relative", overflow: "hidden"
      }}>
        {[...Array(4)].map((_, i) => <div key={i} style={{
          position: "absolute", top: -10, left: `${i * 30}%`,
      ...
      <div style={{ padding: "14px 14px 0" }}>
        ...
        <div style={{ background: "var(--card)", borderRadius: 12, border: "1px solid var(--border)", marginBottom: 12, overflow: "hidden" }}>
          <button onClick={() => setSecOpen(!secOpen)} style={{
          ...
          {secOpen && <div style={{ padding: "0 16px 16px", borderTop: "1px solid var(--border)" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
              ...
              <div onClick={() => { setTwoFA(!twoFA); addToast("Coming Soon 🚀", "info"); }}
                style={{
                  width: 40, height: 22, borderRadius: 11, background: twoFA ? "var(--accent)" : "var(--border)",
                  position: "relative", cursor: "pointer", transition: "background 0.2s"
                }}>
                <div style={{
                  position: "absolute", top: 3, left: twoFA ? 20 : 3, width: 16, height: 16,
                  background: "#fff", borderRadius: "50%", transition: "left 0.2s"
                }} />
              </div>
            </div>
        ...
        {/* KYC */}
        <div style={{ background: "var(--card)", borderRadius: 12, border: "1px solid var(--border)", marginBottom: 12, overflow: "hidden" }}>
          <button onClick={() => setKycOpen(!kycOpen)} style={{
            width: "100%", display: "flex", justifyContent: "space-between",
            alignItems: "center", padding: "14px 16px", background: "none", border: "none", cursor: "pointer"
          }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          {[{ id: "email", label: "Email" }, { id: "sms", label: "SMS" }, { id: "push", label: "Push" }].map(n => (
            <div key={n.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 0" }}>
              ...
              <div onClick={() => setNotif(prev => ({ ...prev, [n.id]: !prev[n.id] }))}
                style={{
                  width: 36, height: 20, borderRadius: 10, background: notif[n.id] ? "var(--accent)" : "var(--border)",
                  position: "relative", cursor: "pointer", transition: "background 0.2s"
                }}>
                <div style={{
                  position: "absolute", top: 2, left: notif[n.id] ? 18 : 2, width: 16, height: 16,
                  background: "#fff", borderRadius: "50%", transition: "left 0.2s"
                }} />
              </div>
            </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 12 }}>
          {[["📞", "Support"], ["📋", "Terms"], ["🔒", "Privacy"], ["🆘", "Help"]].map(([ic, label]) => (
            <button key={label} onClick={() => addToast("Coming Soon 🚀", "info")}
              style={{
                display: "flex", alignItems: "center", gap: 8, padding: "12px", background: "var(--card)",
      ...
      <div style={{ overflowX: "auto", display: "flex", background: "var(--hbg)", borderBottom: "1px solid var(--border)", scrollbarWidth: "none" }}>
        ...
        { id: "transactions", label: "💰 Transactions" }, { id: "promotions", label: "🎁 Promotions" }].map(t => (
          <button key={t.id} onClick={() => setTab(t.id)} style={{
            ...
            fontSize: 12, fontFamily: "var(--font-b)", whiteSpace: "nowrap"
          }}>{t.label}</button>
        ))}
      </div>
      <div style={{ padding: 14 }}>
                ...
                <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
                  <div style={{ display: "flex", gap: 4, flex: 1 }}>
                    {[m.homeOdds, m.drawOdds, m.awayOdds].filter(Boolean).map((o, i) => (
                      <div key={i} style={{
                        background: "var(--bg2)", borderRadius: 6, padding: "4px 8px",
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", marginBottom: 8 }}>
                  <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
                    <div style={{
                      ...
                      display: "flex", alignItems: "center", justifyContent: "center",
                      fontFamily: "var(--font-d)", fontSize: 16, fontWeight: 700, color: "#fff"
                    }}>{u.name[0]}</div>
                    <div>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <div style={{ display: "flex", gap: 6 }}>
                    ...
                    <Btn small variant={u.status === "active" ? "danger" : "primary"}
                      ...
                      {u.status === "active" ? "Suspended" : "Activate"}
                    </Btn>
                  </div>
                </div>
              </div>
              ...
              <div key={i} style={{
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", marginBottom: 6 }}>
                  ...
                  <div style={{ textAlign: "right" }}>
                    <div style={{
                      fontFamily: "var(--font-d)", fontSize: 18, fontWeight: 700,
                      color: t.type !== "withdraw" ? "var(--accent)" : "var(--red)"
                    }}>{fmt(t.amount)}</div>
                    <Badge color={t.status === "Completed" ? "var(--accent)" : t.status === "Pending" ? "var(--gold)" : "var(--red)"}>
                      {t.status === "Completed" ? "Completed" : t.status === "Pending" ? "Pending" : "Failed"}
                    </Badge>
          ...
          <div>
            {["Welcome Bonus — 100% up to ৳5,000", "Daily Reload — 20%", "Referral Bonus — ৳200", "Accumulator Boost — 5-20%"].map((promo, i) => (
              <div key={i} style={{
                ...
                <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
                  <div style={{
                    width: 36, height: 20, borderRadius: 10, background: "var(--accent)",
...
export default function App() {
  ...
  return (
    <div style={{
      ...
      {/* Sticky header (not on admin or auth) */}
      {user && view !== "admin" && view !== "auth" && <Header user={user} nav={nav} betSlip={betSlip} />}
      ...
      <div className="page" key={view} style={{ minHeight: "calc(100vh - 116px)" }}>
        ...
        {view === "sports" && <SportsPage {...commonProps} betSlip={betSlip} setBetSlip={setBetSlip} betHistory={betHistory} />}
        {view === "crash" && <CrashPage {...commonProps} />}
        {view === "casino" && <CasinoPage {...commonProps} />}
        {view === "wallet" && <WalletPage {...commonProps} transactions={transactions} setTransactions={setTransactions} />}
        {view === "promotions" && <PromosPage {...commonProps} />}
      ...
      {/* Bottom nav */}
      {user && view !== "admin" && view !== "auth" && <BottomNav view={view} nav={nav} betSlip={betSlip} />}
